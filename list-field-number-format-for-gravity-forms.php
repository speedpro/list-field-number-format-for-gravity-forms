...
Github Plugin URI: speedpro/list-field-number-format-for-gravity-forms
...
<li class='list_number_settings field_setting'>
  ...
  <input type='checkbox' id='list_number_enable'
    onclick='SetFieldProperty( "isNumber", this.checked );itsg_gf_list_numformat_init();'>
  ...
  <div class="list_choice_number_options_single"
    style="display:none; background: rgb(244, 244, 244) none repeat scroll 0px 0px; padding: 10px; border-bottom: 1px solid grey; margin-top: 10px;">
    ...
    <select style="margin-bottom: 10px;"
      onchange="SetFieldProperty( 'isNumberFormat', this.value);itsg_gf_list_numformat_displayed_options( 'single' )"
      id="list_choice_number_format_single">
    ...
    <select style="margin-bottom: 10px;"
      onchange="SetFieldProperty( 'isNumberRounding', this.value);itsg_gf_list_numformat_displayed_options( 'single' )"
      id="list_choice_number_rounding_single">
    ...
    <br>
    <input type="checkbox" id="list_choice_number_fixed_point_single"
      onclick="SetFieldProperty( 'isNumberFixedPoint', this.checked );">
    ...
    <select style="margin-bottom: 10px;" onchange="SetFieldProperty( 'isNumberRoundingDirection', this.value);"
      id="list_choice_number_rounding_direction_single">
    ...
    <div class="range_min">
      <input type="text" onchange="SetFieldProperty( 'isNumberRangeMin', this.value);"
        id="list_choice_number_range_min_single">
      <label for="list_choice_number_range_min_single">
        <?php _e('Min', 'list-field-number-format-for-gravity-forms'); ?>
      </label>
    </div>
    <div class="range_max">
      <input type="text" onchange="SetFieldProperty( 'isNumberRangeMax', this.value);"
        id="list_choice_number_range_max_single">
      <label for="list_choice_number_range_max_single">
        <?php _e('Max', 'list-field-number-format-for-gravity-forms'); ?>
      </label>
    </div>
    <br>
    <input type="checkbox" id="list_choice_number_range_instructions_single"
      onclick="SetFieldProperty( 'isNumberRangeInstructions', this.checked );">
    ...
    <br><br>
    <input type="checkbox" id="list_choice_number_column_total_single"
      onclick="SetFieldProperty( 'isNumberColumnTotal', this.checked );">
										...
										if (!empty($values)) {
											...
											if ($has_columns) {
												foreach ($column_total as $key => $total) {
													if (rgar($field['choices'][$key], 'isNumberColumnTotal')) {
